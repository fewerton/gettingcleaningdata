...
### The transformations
All data transformations from raw data to tidy data are explained along the functions, as markdown, in the file run_analysis.R


### License related to this dataset
