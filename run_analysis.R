...
## The column names are specific as arguments in the read.table() function, 
## as they are not available in the original txt files.
...
## This add a column naming the exact activity, not just the code referring to it, which is available at dataset activities.
...
write.table(x=independented_tidy_data_step5, file = "independented_tidy_data_step5.txt", row.name=FALSE)
